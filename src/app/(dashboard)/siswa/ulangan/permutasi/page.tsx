...
import {
  ...
  SOAL_DATA,
  SoalKepahaman,
} from "@/components/materi/sections/permutasi/latihan";
...
// ── Page ─────────────────────────────────────────────────────────────────────
export default function AsesmenPermutasiPage() {
    ...
    async function checkAccess() {
      try {
        const res = await fetch(
          "/api/asesmen-formatif/check-access?module_slug=permutasi"
        );
        if (cancelled) return;

        if (!res.ok) {
          // TODO: update check-access API to support permutasi module
  ...
  return (
    <div style={{ maxWidth: 640, margin: "0 auto", padding: "40px 24px" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: 28 }}>
        ...
        >
          Kamu harus menyelesaikan seluruh section pada materi Permutasi sebelum
          dapat mengerjakan latihan formatif ini.
        </p>
      </div>
  ...
  return (
    <div style={{ maxWidth: 700, margin: "0 auto", padding: "0 24px 48px" }}>
      ...
      {integrity.activeToast && (
        <IntegrityToast toast={integrity.activeToast} onDismiss={() => {}} />
      )}
              ...
              <div style={{ padding: "18px 20px" }}>
                ...
                <div style={{ marginBottom: 14 }}>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      onUpdateAnswer(i, "cara_hitung", e.target.value)
                    }
      ...
      >
        ...
        {!showConfirm ? (
          <div style={{ textAlign: "center" }}>
            <p style={{ fontSize: 13, color: "#6b8f6d", marginBottom: 12 }}>
          ...
          >
            ...
            <p
              style={{ fontSize: 13, color: "#6b7280", margin: "0 0 16px" }}
            >
              Kamu telah menjawab{" "}
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <span
                    style={{ fontSize: 12, fontWeight: 700, color: itemColor }}
                  >
